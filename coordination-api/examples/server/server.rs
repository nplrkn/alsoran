//! Main library entry point for coordination_api implementation.
...
pub async fn create(addr: &str, https: bool) {
    ...
    #[allow(unused_mut)]
    let mut service =
        coordination_api::server::context::MakeAddContext::<_, EmptyContext>::new(
            service
        );
