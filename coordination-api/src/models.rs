...
impl WorkerInfo {
    ...
    pub fn new(worker_unique_id: uuid::Uuid, connection_api_url: String, f1_address: String, e1_address: String, connected_amfs: Vec<String>, connected_dus: Vec<String>, connected_ups: Vec<String>, ) -> WorkerInfo {
        WorkerInfo {
            worker_unique_id,
            connection_api_url,
            f1_address,
