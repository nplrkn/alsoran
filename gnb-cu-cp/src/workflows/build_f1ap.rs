...
fn build_ue_context_setup_request<G: GnbCuCp>(
        ...
        rrc::UeCapabilityRatContainerList(vec![UeCapabilityRatContainer {
            ...
            ue_capability_rat_container: UeNrCapability {
                ...
                pdcp_parameters: PdcpParameters {
                    ...
                    max_number_rohc_context_sessions: rrc::MaxNumberRohcContextSessions::Cs2,
    ...
    let cu_to_du_rrc_information = f1ap::CuToDuRrcInformation {
        cg_config_info: None,
        ue_capability_rat_container_list: Some(UeCapabilityRatContainerList(
            rrc_ue_capability_rat_container_list.into_bytes()?,
        )),
        meas_config: None,
