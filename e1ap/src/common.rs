...
impl PrivateIeId {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        match idx {
            0 => Ok(Self::Local(
                xper::decode::decode_integer(data, Some(0), Some(65535), false)?.0 as u16,
            )),
            1 => Ok(Self::Global(xper::decode::decode_octetstring(
...
impl ProtocolExtensionId {
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        xper::encode::encode_integer(data, Some(0), Some(65535), false, self.0 as i128, false)
    }
}
