...
impl UeAssociatedLogicalE1ConnectionListRes {
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        for x in &self.0 {
            let ie = &mut new_codec_data();
            x.encode(ie)?;
            xper::encode::encode_integer(data, Some(0), Some(65535), false, 5, false)?;
...
impl GnbCuUpE1SetupRequest {
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        if let Some(x) = &self.extended_gnb_cu_up_name {
            let ie = &mut new_codec_data();
            x.encode(ie)?;
            xper::encode::encode_integer(ies, Some(0), Some(65535), false, 130, false)?;
            Criticality::Ignore.encode(ies)?;
            xper::encode::encode_length_determinent(ies, None, None, false, ie.length_in_bytes())?;
            ies.append_aligned(ie);
            num_ies += 1;
...
impl SupportedPlmnsList {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        Ok(Self({
            let length = xper::decode::decode_length_determinent(data, Some(1), Some(12), false)?;
            let mut items = vec![];
            for _ in 0..length {
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        xper::encode::encode_length_determinent(data, Some(1), Some(12), false, self.0.len())?;
        for x in &self.0 {
            x.encode(data)?;
        }
        Ok(())
...
impl BearerContextSetupRequest {
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        if let Some(x) = &self.direct_forwarding_path_availability {
            let ie = &mut new_codec_data();
            x.encode(ie)?;
            xper::encode::encode_integer(ies, Some(0), Some(65535), false, 139, false)?;
            Criticality::Ignore.encode(ies)?;
            xper::encode::encode_length_determinent(ies, None, None, false, ie.length_in_bytes())?;
            ies.append_aligned(ie);
            num_ies += 1;
            ...
            match id {
                ...
                89 => {
                    gnb_cu_cp_measurement_id = Some(
                        xper::decode::decode_integer(data, Some(1), Some(4095), true)?.0 as u16,
                    )
                }
                90 => {
