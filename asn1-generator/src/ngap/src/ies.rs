...
impl APerElement for AdditionalDluptnlInformationForHoList {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        Ok(Self(
            Vec::<AdditionalDluptnlInformationForHoItem>::from_aper(decoder, Self::CONSTRAINTS)?,
        ))
    }
...
impl APerElement for DrBsSubjectToEarlyStatusTransferList {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        Ok(Self(
            Vec::<DrBsSubjectToEarlyStatusTransferItem>::from_aper(decoder, Self::CONSTRAINTS)?,
        ))
    }
    fn to_aper(&self, _constraints: Constraints) -> Result<Encoding, EncodeError> {
        let mut enc = Encoding::new();
...
impl APerElement for PduSessionResourceFailedToSetupListHoAck {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        Ok(Self(
            Vec::<PduSessionResourceFailedToSetupItemHoAck>::from_aper(decoder, Self::CONSTRAINTS)?,
        ))
    }
    fn to_aper(&self, _constraints: Constraints) -> Result<Encoding, EncodeError> {
        let mut enc = Encoding::new();
...
impl APerElement for PduSessionResourceFailedToSetupListPsReq {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        Ok(Self(
            Vec::<PduSessionResourceFailedToSetupItemPsReq>::from_aper(decoder, Self::CONSTRAINTS)?,
        ))
    }
    fn to_aper(&self, _constraints: Constraints) -> Result<Encoding, EncodeError> {
        let mut enc = Encoding::new();
...
impl APerElement for PduSessionResourceFailedToSetupListSuRes {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        Ok(Self(
            Vec::<PduSessionResourceFailedToSetupItemSuRes>::from_aper(decoder, Self::CONSTRAINTS)?,
        ))
    }
    fn to_aper(&self, _constraints: Constraints) -> Result<Encoding, EncodeError> {
        let mut enc = Encoding::new();
...
impl APerElement for PduSessionResourceReleasedListPsFail {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        Ok(Self(
            Vec::<PduSessionResourceReleasedItemPsFail>::from_aper(decoder, Self::CONSTRAINTS)?,
        ))
    }
    fn to_aper(&self, _constraints: Constraints) -> Result<Encoding, EncodeError> {
        let mut enc = Encoding::new();
...
impl APerElement for PduSessionResourceReleasedListRelRes {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        Ok(Self(
            Vec::<PduSessionResourceReleasedItemRelRes>::from_aper(decoder, Self::CONSTRAINTS)?,
        ))
    }
    fn to_aper(&self, _constraints: Constraints) -> Result<Encoding, EncodeError> {
        let mut enc = Encoding::new();
...
impl APerElement for PduSessionResourceSecondaryRatUsageList {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        Ok(Self(
            Vec::<PduSessionResourceSecondaryRatUsageItem>::from_aper(decoder, Self::CONSTRAINTS)?,
        ))
    }
    fn to_aper(&self, _constraints: Constraints) -> Result<Encoding, EncodeError> {
        let mut enc = Encoding::new();
...
impl APerElement for PduSessionResourceToBeSwitchedDlList {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        Ok(Self(
            Vec::<PduSessionResourceToBeSwitchedDlItem>::from_aper(decoder, Self::CONSTRAINTS)?,
        ))
    }
    fn to_aper(&self, _constraints: Constraints) -> Result<Encoding, EncodeError> {
        let mut enc = Encoding::new();
...
impl APerElement for PduSessionResourceToReleaseListHoCmd {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        Ok(Self(
            Vec::<PduSessionResourceToReleaseItemHoCmd>::from_aper(decoder, Self::CONSTRAINTS)?,
        ))
    }
    fn to_aper(&self, _constraints: Constraints) -> Result<Encoding, EncodeError> {
        let mut enc = Encoding::new();
...
impl APerElement for PduSessionResourceToReleaseListRelCmd {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        Ok(Self(
            Vec::<PduSessionResourceToReleaseItemRelCmd>::from_aper(decoder, Self::CONSTRAINTS)?,
        ))
    }
    fn to_aper(&self, _constraints: Constraints) -> Result<Encoding, EncodeError> {
        let mut enc = Encoding::new();
