...
impl APerElement for ExpectedUeActivityBehaviour {
    ...
    fn to_aper(&self, constraints: Constraints) -> Result<Encoding, EncodeError> {
        ...
        optionals.set(2, self.source_of_ue_activity_behaviour_information.is_some());
        optionals.set(3, false);
...
impl APerElement for LastVisitedNgranCellInformation {
    ...
    fn to_aper(&self, constraints: Constraints) -> Result<Encoding, EncodeError> {
        let mut enc = Encoding::new();
        let mut optionals = BitString::with_len(3);
        optionals.set(0, self.time_ue_stayed_in_cell_enhanced_granularity.is_some());
...
impl APerElement for LocationReportingRequestType {
    ...
    fn to_aper(&self, constraints: Constraints) -> Result<Encoding, EncodeError> {
        ...
        optionals.set(1, self.location_reporting_reference_id_to_be_cancelled.is_some());
        optionals.set(2, false);
...
impl APerElement for PduSessionResourceModifyRequestTransfer {
    ...
    fn from_aper(decoder: &mut Decoder, constraints: Constraints) -> Result<Self, DecodeError> {
        ...
        let mut additional_redundant_ul_ngu_up_tnl_information: Option<UpTransportLayerInformationList> = None;
        ...
        for _ in 0..len {
            ...
            match id {
                130 => {
                    pdu_session_aggregate_maximum_bit_rate = Some(PduSessionAggregateMaximumBitRate::from_aper(decoder, UNCONSTRAINED)?);
                }
                140 => {
                    ul_ngu_up_tnl_modify_list = Some(UlNguUpTnlModifyList::from_aper(decoder, UNCONSTRAINED)?);
                }
                129 => {
                    network_instance = Some(NetworkInstance::from_aper(decoder, UNCONSTRAINED)?);
                }
                135 => {
                    qos_flow_add_or_modify_request_list = Some(QosFlowAddOrModifyRequestList::from_aper(decoder, UNCONSTRAINED)?);
                }
                137 => {
                    qos_flow_to_release_list = Some(QosFlowListWithCause::from_aper(decoder, UNCONSTRAINED)?);
                }
                126 => {
                    additional_ul_ngu_up_tnl_information = Some(UpTransportLayerInformationList::from_aper(decoder, UNCONSTRAINED)?);
                }
                166 => {
                    common_network_instance = Some(CommonNetworkInstance::from_aper(decoder, UNCONSTRAINED)?);
                }
                186 => {
                    additional_redundant_ul_ngu_up_tnl_information = Some(UpTransportLayerInformationList::from_aper(decoder, UNCONSTRAINED)?);
                }
                190 => {
                    redundant_common_network_instance = Some(CommonNetworkInstance::from_aper(decoder, UNCONSTRAINED)?);
                }
                195 => {
                    redundant_ul_ngu_up_tnl_information = Some(UpTransportLayerInformation::from_aper(decoder, UNCONSTRAINED)?);
                }
                138 => {
                    security_indication = Some(SecurityIndication::from_aper(decoder, UNCONSTRAINED)?);
                }
                _ => {
    ...
    fn from_aper(decoder: &mut Decoder, constraints: Constraints) -> Result<Self, DecodeError> {
        ...
        for _ in 0..len {
            ...
            match id {
                ...
                139 => {
                    ul_ngu_up_tnl_information = Some(UpTransportLayerInformation::from_aper(decoder, UNCONSTRAINED)?);
                }
                126 => {
                    additional_ul_ngu_up_tnl_information = Some(UpTransportLayerInformationList::from_aper(decoder, UNCONSTRAINED)?);
                }
                127 => {
                    data_forwarding_not_possible = Some(DataForwardingNotPossible::from_aper(decoder, UNCONSTRAINED)?);
                }
                134 => {
                ...
                136 => {
                    qos_flow_setup_request_list = Some(QosFlowSetupRequestList::from_aper(decoder, UNCONSTRAINED)?);
                }
                166 => {
                    common_network_instance = Some(CommonNetworkInstance::from_aper(decoder, UNCONSTRAINED)?);
                }
                ...
                197 => {
                    redundant_pdu_session_information = Some(RedundantPduSessionInformation::from_aper(decoder, UNCONSTRAINED)?);
                }
                _ => {
                    if let Criticality::Reject = criticality {
                        return Err(DecodeError::InvalidChoice);
        ...
        let ul_ngu_up_tnl_information = ul_ngu_up_tnl_information.ok_or(Err(DecodeError::InvalidChoice))?;
        let pdu_session_type = pdu_session_type.ok_or(Err(DecodeError::InvalidChoice))?;
        let qos_flow_setup_request_list = qos_flow_setup_request_list.ok_or(Err(DecodeError::InvalidChoice))?;
        Ok(Self {
            pdu_session_aggregate_maximum_bit_rate,
            ul_ngu_up_tnl_information,
            additional_ul_ngu_up_tnl_information,
