...
#[allow(unused_imports)]
use num_traits::FromPrimitive;use super::common::*;
use super::ies::*;
...
impl APerElement for GnbDuResourceCoordinationRequest {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        ...
        let eutra_nr_cell_resource_coordination_req_container = eutra_nr_cell_resource_coordination_req_container.ok_or(DecodeError::InvalidChoice)?;
        Ok(Self {
            transaction_id,
            request_type,
...
impl APerElement for GnbDuResourceCoordinationResponse {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        ...
        let transaction_id = transaction_id.ok_or(DecodeError::InvalidChoice)?;
        let eutra_nr_cell_resource_coordination_req_ack_container = eutra_nr_cell_resource_coordination_req_ack_container.ok_or(DecodeError::InvalidChoice)?;
        Ok(Self {
            transaction_id,
...
impl APerElement for WriteReplaceWarningRequest {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        ...
        let numberof_broadcast_request = numberof_broadcast_request.ok_or(DecodeError::InvalidChoice)?;
        Ok(Self {
            transaction_id,
...
impl APerElement for PwsRestartIndication {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        ...
        let transaction_id = transaction_id.ok_or(DecodeError::InvalidChoice)?;
        let nr_cgi_list_for_restart_list = nr_cgi_list_for_restart_list.ok_or(DecodeError::InvalidChoice)?;
        Ok(Self {
            transaction_id,
...
impl APerElement for GnbDuStatusIndication {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        ...
        let transaction_id = transaction_id.ok_or(DecodeError::InvalidChoice)?;
        let gnb_du_overload_information = gnb_du_overload_information.ok_or(DecodeError::InvalidChoice)?;
        Ok(Self {
            transaction_id,
...
impl APerElement for CellTrafficTrace {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        ...
        let gnb_du_ue_f1ap_id = gnb_du_ue_f1ap_id.ok_or(DecodeError::InvalidChoice)?;
        let trace_id = trace_id.ok_or(DecodeError::InvalidChoice)?;
        let trace_collection_entity_ip_address = trace_collection_entity_ip_address.ok_or(DecodeError::InvalidChoice)?;
        Ok(Self {
            gnb_cu_ue_f1ap_id,
            gnb_du_ue_f1ap_id,
            trace_id,
...
impl APerElement for DucuRadioInformationTransfer {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        ...
        let transaction_id = transaction_id.ok_or(DecodeError::InvalidChoice)?;
        let ducu_radio_information_type = ducu_radio_information_type.ok_or(DecodeError::InvalidChoice)?;
        Ok(Self {
            transaction_id,
...
impl APerElement for CuduRadioInformationTransfer {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        ...
        let transaction_id = transaction_id.ok_or(DecodeError::InvalidChoice)?;
        let cudu_radio_information_type = cudu_radio_information_type.ok_or(DecodeError::InvalidChoice)?;
        Ok(Self {
            transaction_id,
...
impl APerElement for IabtnlAddressResponse {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        ...
        let transaction_id = transaction_id.ok_or(DecodeError::InvalidChoice)?;
        let iab_allocated_tnl_address_list = iab_allocated_tnl_address_list.ok_or(DecodeError::InvalidChoice)?;
        Ok(Self {
            transaction_id,
...
impl APerElement for ReferenceTimeInformationReport {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        ...
        let transaction_id = transaction_id.ok_or(DecodeError::InvalidChoice)?;
        let time_reference_information = time_reference_information.ok_or(DecodeError::InvalidChoice)?;
        Ok(Self {
            transaction_id,
...
impl APerElement for PositioningMeasurementRequest {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        ...
        let trp_measurement_request_list = trp_measurement_request_list.ok_or(DecodeError::InvalidChoice)?;
        let pos_report_characteristics = pos_report_characteristics.ok_or(DecodeError::InvalidChoice)?;
        let pos_measurement_quantities = pos_measurement_quantities.ok_or(DecodeError::InvalidChoice)?;
        Ok(Self {
            transaction_id,
            lmf_measurement_id,
            ran_measurement_id,
...
impl APerElement for PositioningMeasurementReport {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        ...
        let lmf_measurement_id = lmf_measurement_id.ok_or(DecodeError::InvalidChoice)?;
        let ran_measurement_id = ran_measurement_id.ok_or(DecodeError::InvalidChoice)?;
        let pos_measurement_result_list = pos_measurement_result_list.ok_or(DecodeError::InvalidChoice)?;
        Ok(Self {
            transaction_id,
            lmf_measurement_id,
            ran_measurement_id,
...
impl APerElement for TrpInformationRequest {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        ...
        let transaction_id = transaction_id.ok_or(DecodeError::InvalidChoice)?;
        let trp_information_type_list_trp_req = trp_information_type_list_trp_req.ok_or(DecodeError::InvalidChoice)?;
        Ok(Self {
            transaction_id,
            trp_list,
...
impl APerElement for TrpInformationResponse {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        ...
        let transaction_id = transaction_id.ok_or(DecodeError::InvalidChoice)?;
        let trp_information_list_trp_resp = trp_information_list_trp_resp.ok_or(DecodeError::InvalidChoice)?;
        Ok(Self {
            transaction_id,
...
impl APerElement for ECidMeasurementInitiationRequest {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        ...
        let e_cid_report_characteristics = e_cid_report_characteristics.ok_or(DecodeError::InvalidChoice)?;
        let e_cid_measurement_quantities = e_cid_measurement_quantities.ok_or(DecodeError::InvalidChoice)?;
        Ok(Self {
            gnb_cu_ue_f1ap_id,
            gnb_du_ue_f1ap_id,
...
impl APerElement for ECidMeasurementReport {
    ...
    fn from_aper(decoder: &mut Decoder, _constraints: Constraints) -> Result<Self, DecodeError> {
        ...
        let lmf_ue_measurement_id = lmf_ue_measurement_id.ok_or(DecodeError::InvalidChoice)?;
        let ran_ue_measurement_id = ran_ue_measurement_id.ok_or(DecodeError::InvalidChoice)?;
        let e_cid_measurement_result = e_cid_measurement_result.ok_or(DecodeError::InvalidChoice)?;
        Ok(Self {
            gnb_cu_ue_f1ap_id,
            gnb_du_ue_f1ap_id,
            lmf_ue_measurement_id,
