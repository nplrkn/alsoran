...
USE_ASN1_APER = """\
    ...
    use net::{PerCodec, new_codec_data_aper as new_codec_data};
"""
USE_ASN1_UPER = """\
    use asn1_codecs::{uper as xper, PerCodecData, PerCodecError};
    use net::PerCodec;
"""
USE_BITSTRING = """\
use bitvec::prelude::*;
