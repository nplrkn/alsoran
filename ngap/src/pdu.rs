...
impl PduSessionResourceSetupRequest {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            match id {
                ...
                85 => ran_ue_ngap_id = Some(RanUeNgapId::aper_decode(data)?),
                83 => ran_paging_priority = Some(RanPagingPriority::aper_decode(data)?),
                38 => nas_pdu = Some(NasPdu::aper_decode(data)?),
                74 => {
                    pdu_session_resource_setup_list_su_req =
                        Some(PduSessionResourceSetupListSuReq::aper_decode(data)?)
                }
                110 => {
                    ue_aggregate_maximum_bit_rate =
                        Some(UeAggregateMaximumBitRate::aper_decode(data)?)
                }
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.ran_ue_ngap_id.aper_encode(ie)?;
            ...
            match id {
                ...
                75 => {
                    pdu_session_resource_setup_list_su_res =
                        Some(PduSessionResourceSetupListSuRes::aper_decode(data)?)
                }
                58 => {
                    pdu_session_resource_failed_to_setup_list_su_res =
                        Some(PduSessionResourceFailedToSetupListSuRes::aper_decode(data)?)
                }
                19 => criticality_diagnostics = Some(CriticalityDiagnostics::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
        let amf_ue_ngap_id = amf_ue_ngap_id.ok_or(PerCodecError::new(format!(
            ...
            match id {
                ...
                79 => {
                    pdu_session_resource_to_release_list_rel_cmd =
                        Some(PduSessionResourceToReleaseListRelCmd::aper_decode(data)?)
                }
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
            ...
            match id {
                ...
                70 => {
                    pdu_session_resource_released_list_rel_res =
                        Some(PduSessionResourceReleasedListRelRes::aper_decode(data)?)
                }
                121 => {
                    user_location_information = Some(UserLocationInformation::aper_decode(data)?)
                }
                19 => criticality_diagnostics = Some(CriticalityDiagnostics::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
            ...
            match id {
                ...
                64 => {
                    pdu_session_resource_modify_list_mod_req =
                        Some(PduSessionResourceModifyListModReq::aper_decode(data)?)
                }
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
            ...
            match id {
                ...
                65 => {
                    pdu_session_resource_modify_list_mod_res =
                        Some(PduSessionResourceModifyListModRes::aper_decode(data)?)
                }
                54 => {
                    pdu_session_resource_failed_to_modify_list_mod_res = Some(
                        PduSessionResourceFailedToModifyListModRes::aper_decode(data)?,
                    )
                }
                121 => {
                    user_location_information = Some(UserLocationInformation::aper_decode(data)?)
            ...
            match id {
                ...
                66 => {
                    pdu_session_resource_notify_list =
                        Some(PduSessionResourceNotifyList::aper_decode(data)?)
                }
                67 => {
                    pdu_session_resource_released_list_not =
                        Some(PduSessionResourceReleasedListNot::aper_decode(data)?)
                }
                121 => {
                    user_location_information = Some(UserLocationInformation::aper_decode(data)?)
                }
            ...
            match id {
                ...
                63 => {
                    pdu_session_resource_modify_list_mod_ind =
                        Some(PduSessionResourceModifyListModInd::aper_decode(data)?)
                }
                121 => {
                    user_location_information = Some(UserLocationInformation::aper_decode(data)?)
                }
            ...
            match id {
                ...
                62 => {
                    pdu_session_resource_modify_list_mod_cfm =
                        Some(PduSessionResourceModifyListModCfm::aper_decode(data)?)
                }
                131 => {
                    pdu_session_resource_failed_to_modify_list_mod_cfm = Some(
                        PduSessionResourceFailedToModifyListModCfm::aper_decode(data)?,
                    )
                }
                19 => criticality_diagnostics = Some(CriticalityDiagnostics::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
...
impl InitialContextSetupRequest {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            match id {
                10 => amf_ue_ngap_id = Some(AmfUeNgapId::aper_decode(data)?),
                85 => ran_ue_ngap_id = Some(RanUeNgapId::aper_decode(data)?),
                48 => old_amf = Some(AmfName::aper_decode(data)?),
                110 => {
                    ue_aggregate_maximum_bit_rate =
                        Some(UeAggregateMaximumBitRate::aper_decode(data)?)
                }
                18 => {
                    core_network_assistance_information_for_inactive = Some(
                        CoreNetworkAssistanceInformationForInactive::aper_decode(data)?,
                    )
                }
                28 => guami = Some(Guami::aper_decode(data)?),
                71 => {
                    pdu_session_resource_setup_list_cxt_req =
                        Some(PduSessionResourceSetupListCxtReq::aper_decode(data)?)
                }
                0 => allowed_nssai = Some(AllowedNssai::aper_decode(data)?),
                119 => ue_security_capabilities = Some(UeSecurityCapabilities::aper_decode(data)?),
                94 => security_key = Some(SecurityKey::aper_decode(data)?),
                108 => trace_activation = Some(TraceActivation::aper_decode(data)?),
                36 => mobility_restriction_list = Some(MobilityRestrictionList::aper_decode(data)?),
                117 => ue_radio_capability = Some(UeRadioCapability::aper_decode(data)?),
                31 => index_to_rfsp = Some(IndexToRfsp::aper_decode(data)?),
                34 => masked_imeisv = Some(MaskedImeisv::aper_decode(data)?),
                38 => nas_pdu = Some(NasPdu::aper_decode(data)?),
                24 => {
                    emergency_fallback_indicator =
                        Some(EmergencyFallbackIndicator::aper_decode(data)?)
                }
                91 => {
                    rrc_inactive_transition_report_request =
                        Some(RrcInactiveTransitionReportRequest::aper_decode(data)?)
                }
                118 => {
                    ue_radio_capability_for_paging =
                        Some(UeRadioCapabilityForPaging::aper_decode(data)?)
                }
                146 => {
                    redirection_voice_fallback = Some(RedirectionVoiceFallback::aper_decode(data)?)
                }
                33 => {
                    location_reporting_request_type =
                        Some(LocationReportingRequestType::aper_decode(data)?)
                }
                165 => cn_assisted_ran_tuning = Some(CnAssistedRanTuning::aper_decode(data)?),
                177 => srvcc_operation_possible = Some(SrvccOperationPossible::aper_decode(data)?),
                199 => iab_authorized = Some(IabAuthorized::aper_decode(data)?),
                205 => {
                    enhanced_coverage_restriction =
                        Some(EnhancedCoverageRestriction::aper_decode(data)?)
                }
                206 => extended_connected_time = Some(ExtendedConnectedTime::aper_decode(data)?),
                209 => ue_differentiation_info = Some(UeDifferentiationInfo::aper_decode(data)?),
                216 => {
                ...
                219 => pc5_qos_parameters = Some(Pc5QosParameters::aper_decode(data)?),
                222 => c_emode_brestricted = Some(CEmodeBrestricted::aper_decode(data)?),
                234 => ue_up_c_iot_support = Some(UeUpCIotSupport::aper_decode(data)?),
                238 => {
                    rg_level_wireline_access_characteristics =
                        Some(RgLevelWirelineAccessCharacteristics::aper_decode(data)?)
                }
                254 => management_based_mdt_plmn_list = Some(MdtPlmnList::aper_decode(data)?),
                264 => ue_radio_capability_id = Some(UeRadioCapabilityId::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
        let amf_ue_ngap_id = amf_ue_ngap_id.ok_or(PerCodecError::new(format!(
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.allowed_nssai.aper_encode(ie)?;
        ...
        let ie = &mut PerCodecData::new_aper();
        self.ue_security_capabilities.aper_encode(ie)?;
        ...
        let ie = &mut PerCodecData::new_aper();
        self.security_key.aper_encode(ie)?;
            ...
            match id {
                ...
                72 => {
                    pdu_session_resource_setup_list_cxt_res =
                        Some(PduSessionResourceSetupListCxtRes::aper_decode(data)?)
                }
                55 => {
                    pdu_session_resource_failed_to_setup_list_cxt_res = Some(
                        PduSessionResourceFailedToSetupListCxtRes::aper_decode(data)?,
                    )
                }
                19 => criticality_diagnostics = Some(CriticalityDiagnostics::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
    ...
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            match id {
                ...
                85 => ran_ue_ngap_id = Some(RanUeNgapId::aper_decode(data)?),
                132 => {
                    pdu_session_resource_failed_to_setup_list_cxt_fail = Some(
                        PduSessionResourceFailedToSetupListCxtFail::aper_decode(data)?,
                    )
                }
                15 => cause = Some(Cause::aper_decode(data)?),
                19 => criticality_diagnostics = Some(CriticalityDiagnostics::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
            ...
            match id {
                ...
                133 => {
                    pdu_session_resource_list_cxt_rel_req =
                        Some(PduSessionResourceListCxtRelReq::aper_decode(data)?)
                }
                15 => cause = Some(Cause::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
...
impl UeContextReleaseCommand {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            let _ = aper::decode::decode_length_determinent(data, None, None, false)?;
            match id {
                114 => ue_ngap_i_ds = Some(UeNgapIDs::aper_decode(data)?),
                15 => cause = Some(Cause::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.ue_ngap_i_ds.aper_encode(ie)?;
    ...
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            match id {
                ...
                32 => {
                    info_on_recommended_cells_and_ran_nodes_for_paging = Some(
                        InfoOnRecommendedCellsAndRanNodesForPaging::aper_decode(data)?,
                    )
                }
                60 => {
                    pdu_session_resource_list_cxt_rel_cpl =
                        Some(PduSessionResourceListCxtRelCpl::aper_decode(data)?)
                }
                19 => criticality_diagnostics = Some(CriticalityDiagnostics::aper_decode(data)?),
                207 => {
                    paging_assis_datafor_c_ecapab_ue =
                        Some(PagingAssisDataforCEcapabUe::aper_decode(data)?)
                }
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
...
impl UeContextResumeRequest {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            match id {
                10 => amf_ue_ngap_id = Some(AmfUeNgapId::aper_decode(data)?),
                85 => ran_ue_ngap_id = Some(RanUeNgapId::aper_decode(data)?),
                237 => rrc_resume_cause = Some(RrcEstablishmentCause::aper_decode(data)?),
                232 => {
                    pdu_session_resource_resume_list_res_req =
                        Some(PduSessionResourceResumeListResReq::aper_decode(data)?)
                }
                229 => {
                    pdu_session_resource_failed_to_resume_list_res_req = Some(
                        PduSessionResourceFailedToResumeListResReq::aper_decode(data)?,
                    )
                }
                235 => {
                    suspend_request_indication = Some(SuspendRequestIndication::aper_decode(data)?)
                }
                32 => {
                    info_on_recommended_cells_and_ran_nodes_for_paging = Some(
                        InfoOnRecommendedCellsAndRanNodesForPaging::aper_decode(data)?,
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.rrc_resume_cause.aper_encode(ie)?;
            ...
            match id {
                ...
                233 => {
                    pdu_session_resource_resume_list_res_res =
                        Some(PduSessionResourceResumeListResRes::aper_decode(data)?)
                }
                230 => {
                    pdu_session_resource_failed_to_resume_list_res_res = Some(
                        PduSessionResourceFailedToResumeListResRes::aper_decode(data)?,
                    )
                }
                93 => security_context = Some(SecurityContext::aper_decode(data)?),
                236 => {
                    suspend_response_indication =
                        Some(SuspendResponseIndication::aper_decode(data)?)
                }
                206 => extended_connected_time = Some(ExtendedConnectedTime::aper_decode(data)?),
                19 => criticality_diagnostics = Some(CriticalityDiagnostics::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            ...
            match id {
                ...
                231 => {
                    pdu_session_resource_suspend_list_sus_req =
                        Some(PduSessionResourceSuspendListSusReq::aper_decode(data)?)
                }
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
    ...
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            match id {
                ...
                40 => new_amf_ue_ngap_id = Some(AmfUeNgapId::aper_decode(data)?),
                91 => {
                    rrc_inactive_transition_report_request =
                        Some(RrcInactiveTransitionReportRequest::aper_decode(data)?)
                }
                162 => new_guami = Some(Guami::aper_decode(data)?),
                165 => cn_assisted_ran_tuning = Some(CnAssistedRanTuning::aper_decode(data)?),
                177 => srvcc_operation_possible = Some(SrvccOperationPossible::aper_decode(data)?),
                199 => iab_authorized = Some(IabAuthorized::aper_decode(data)?),
                216 => {
    ...
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            match id {
                10 => amf_ue_ngap_id = Some(AmfUeNgapId::aper_decode(data)?),
                85 => ran_ue_ngap_id = Some(RanUeNgapId::aper_decode(data)?),
                92 => rrc_state = Some(RrcState::aper_decode(data)?),
                121 => {
                    user_location_information = Some(UserLocationInformation::aper_decode(data)?)
                }
                19 => criticality_diagnostics = Some(CriticalityDiagnostics::aper_decode(data)?),
...
impl RrcInactiveTransitionReport {
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.user_location_information.aper_encode(ie)?;
        aper::encode::encode_integer(ies, Some(0), Some(65535), false, 121, false)?;
        Criticality::Ignore.aper_encode(ies)?;
        aper::encode::encode_length_determinent(ies, None, None, false, ie.length_in_bytes())?;
        ies.append_aligned(ie);
...
impl RetrieveUeInformation {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            let _ = aper::decode::decode_length_determinent(data, None, None, false)?;
            match id {
                26 => five_g_s_tmsi = Some(FiveGSTmsi::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.five_g_s_tmsi.aper_encode(ie)?;
...
impl UeInformationTransfer {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            match id {
                26 => five_g_s_tmsi = Some(FiveGSTmsi::aper_decode(data)?),
                210 => nb_iot_ue_priority = Some(NbIotUePriority::aper_decode(data)?),
                117 => ue_radio_capability = Some(UeRadioCapability::aper_decode(data)?),
                148 => s_nssai = Some(SNssai::aper_decode(data)?),
                0 => allowed_nssai = Some(AllowedNssai::aper_decode(data)?),
                209 => ue_differentiation_info = Some(UeDifferentiationInfo::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
...
impl RancpRelocationIndication {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            match id {
                85 => ran_ue_ngap_id = Some(RanUeNgapId::aper_decode(data)?),
                26 => five_g_s_tmsi = Some(FiveGSTmsi::aper_decode(data)?),
                25 => eutra_cgi = Some(EutraCgi::aper_decode(data)?),
                213 => tai = Some(Tai::aper_decode(data)?),
                211 => {
                    ul_cp_security_information = Some(UlCpSecurityInformation::aper_decode(data)?)
                }
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.ul_cp_security_information.aper_encode(ie)?;
...
impl HandoverRequired {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            match id {
                10 => amf_ue_ngap_id = Some(AmfUeNgapId::aper_decode(data)?),
                85 => ran_ue_ngap_id = Some(RanUeNgapId::aper_decode(data)?),
                29 => handover_type = Some(HandoverType::aper_decode(data)?),
                15 => cause = Some(Cause::aper_decode(data)?),
                105 => target_id = Some(TargetId::aper_decode(data)?),
                22 => {
                ...
                61 => {
                    pdu_session_resource_list_ho_rqd =
                        Some(PduSessionResourceListHoRqd::aper_decode(data)?)
                }
                101 => {
                    source_to_target_transparent_container =
                        Some(SourceToTargetTransparentContainer::aper_decode(data)?)
                }
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.handover_type.aper_encode(ie)?;
        ...
        let ie = &mut PerCodecData::new_aper();
        self.pdu_session_resource_list_ho_rqd.aper_encode(ie)?;
            ...
            match id {
                ...
                39 => {
                    nas_security_parameters_from_ngran =
                        Some(NasSecurityParametersFromNgran::aper_decode(data)?)
                }
                59 => {
                    pdu_session_resource_handover_list =
                        Some(PduSessionResourceHandoverList::aper_decode(data)?)
                }
                78 => {
                    pdu_session_resource_to_release_list_ho_cmd =
                        Some(PduSessionResourceToReleaseListHoCmd::aper_decode(data)?)
                }
                106 => {
                    target_to_source_transparent_container =
                        Some(TargetToSourceTransparentContainer::aper_decode(data)?)
                }
                19 => criticality_diagnostics = Some(CriticalityDiagnostics::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
    ...
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            match id {
                ...
                19 => criticality_diagnostics = Some(CriticalityDiagnostics::aper_decode(data)?),
                262 => {
                    targetto_source_failure_transparent_container = Some(
                        TargettoSourceFailureTransparentContainer::aper_decode(data)?,
                    )
                }
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
...
impl HandoverRequest {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            match id {
                ...
                119 => ue_security_capabilities = Some(UeSecurityCapabilities::aper_decode(data)?),
                93 => security_context = Some(SecurityContext::aper_decode(data)?),
                41 => new_security_context_ind = Some(NewSecurityContextInd::aper_decode(data)?),
                37 => nasc = Some(NasPdu::aper_decode(data)?),
                73 => {
                    pdu_session_resource_setup_list_ho_req =
                        Some(PduSessionResourceSetupListHoReq::aper_decode(data)?)
                }
                0 => allowed_nssai = Some(AllowedNssai::aper_decode(data)?),
                108 => trace_activation = Some(TraceActivation::aper_decode(data)?),
                34 => masked_imeisv = Some(MaskedImeisv::aper_decode(data)?),
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.ue_aggregate_maximum_bit_rate.aper_encode(ie)?;
        aper::encode::encode_integer(ies, Some(0), Some(65535), false, 110, false)?;
        Criticality::Reject.aper_encode(ies)?;
        aper::encode::encode_length_determinent(ies, None, None, false, ie.length_in_bytes())?;
        ies.append_aligned(ie);
        ...
        let ie = &mut PerCodecData::new_aper();
        self.security_context.aper_encode(ie)?;
        aper::encode::encode_integer(ies, Some(0), Some(65535), false, 93, false)?;
        Criticality::Reject.aper_encode(ies)?;
        aper::encode::encode_length_determinent(ies, None, None, false, ie.length_in_bytes())?;
        ies.append_aligned(ie);
...
impl HandoverRequestAcknowledge {
            ...
            match id {
                ...
                53 => {
                    pdu_session_resource_admitted_list =
                        Some(PduSessionResourceAdmittedList::aper_decode(data)?)
                }
                56 => {
                    pdu_session_resource_failed_to_setup_list_ho_ack =
                        Some(PduSessionResourceFailedToSetupListHoAck::aper_decode(data)?)
                }
                106 => {
                    target_to_source_transparent_container =
                        Some(TargetToSourceTransparentContainer::aper_decode(data)?)
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.pdu_session_resource_admitted_list.aper_encode(ie)?;
    ...
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            match id {
                ...
                269 => notify_source_ngran_node = Some(NotifySourceNgranNode::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
        let amf_ue_ngap_id = amf_ue_ngap_id.ok_or(PerCodecError::new(format!(
...
impl PathSwitchRequest {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            match id {
                85 => ran_ue_ngap_id = Some(RanUeNgapId::aper_decode(data)?),
                100 => source_amf_ue_ngap_id = Some(AmfUeNgapId::aper_decode(data)?),
                121 => {
                    user_location_information = Some(UserLocationInformation::aper_decode(data)?)
                }
                119 => ue_security_capabilities = Some(UeSecurityCapabilities::aper_decode(data)?),
                76 => {
                    pdu_session_resource_to_be_switched_dl_list =
                        Some(PduSessionResourceToBeSwitchedDlList::aper_decode(data)?)
                }
                57 => {
                    pdu_session_resource_failed_to_setup_list_ps_req =
                        Some(PduSessionResourceFailedToSetupListPsReq::aper_decode(data)?)
                }
                237 => rrc_resume_cause = Some(RrcEstablishmentCause::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.source_amf_ue_ngap_id.aper_encode(ie)?;
...
impl PathSwitchRequestAcknowledge {
            ...
            match id {
                ...
                77 => {
                    pdu_session_resource_switched_list =
                        Some(PduSessionResourceSwitchedList::aper_decode(data)?)
                }
                68 => {
                    pdu_session_resource_released_list_ps_ack =
                        Some(PduSessionResourceReleasedListPsAck::aper_decode(data)?)
                }
                0 => allowed_nssai = Some(AllowedNssai::aper_decode(data)?),
                18 => {
                    core_network_assistance_information_for_inactive = Some(
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.pdu_session_resource_switched_list.aper_encode(ie)?;
            ...
            match id {
                ...
                69 => {
                    pdu_session_resource_released_list_ps_fail =
                        Some(PduSessionResourceReleasedListPsFail::aper_decode(data)?)
                }
                19 => criticality_diagnostics = Some(CriticalityDiagnostics::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
            ...
            match id {
                ...
                268 => {
                    early_status_transfer_transparent_container =
                        Some(EarlyStatusTransferTransparentContainer::aper_decode(data)?)
                }
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
            ...
            match id {
                ...
                84 => {
                    ran_status_transfer_transparent_container =
                        Some(RanStatusTransferTransparentContainer::aper_decode(data)?)
                }
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
...
impl Paging {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            let _ = aper::decode::decode_length_determinent(data, None, None, false)?;
            match id {
                115 => ue_paging_identity = Some(UePagingIdentity::aper_decode(data)?),
                50 => paging_drx = Some(PagingDrx::aper_decode(data)?),
                103 => tai_list_for_paging = Some(TaiListForPaging::aper_decode(data)?),
                52 => paging_priority = Some(PagingPriority::aper_decode(data)?),
                118 => {
                    ue_radio_capability_for_paging =
                        Some(UeRadioCapabilityForPaging::aper_decode(data)?)
                }
                51 => paging_origin = Some(PagingOrigin::aper_decode(data)?),
                11 => {
                    assistance_data_for_paging = Some(AssistanceDataForPaging::aper_decode(data)?)
                }
                203 => nb_iot_paging_e_drx_info = Some(NbIotPagingEDrxInfo::aper_decode(data)?),
                202 => nb_iot_paging_drx = Some(NbIotPagingDrx::aper_decode(data)?),
                205 => {
                    enhanced_coverage_restriction =
                        Some(EnhancedCoverageRestriction::aper_decode(data)?)
                }
                208 => {
                    wus_assistance_information = Some(WusAssistanceInformation::aper_decode(data)?)
                }
                223 => paginge_drx_information = Some(PagingeDrxInformation::aper_decode(data)?),
                222 => c_emode_brestricted = Some(CEmodeBrestricted::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.ue_paging_identity.aper_encode(ie)?;
        ...
        let ie = &mut PerCodecData::new_aper();
        self.tai_list_for_paging.aper_encode(ie)?;
...
impl InitialUeMessage {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            match id {
                ...
                90 => rrc_establishment_cause = Some(RrcEstablishmentCause::aper_decode(data)?),
                26 => five_g_s_tmsi = Some(FiveGSTmsi::aper_decode(data)?),
                3 => amf_set_id = Some(AmfSetId::aper_decode(data)?),
                112 => ue_context_request = Some(UeContextRequest::aper_decode(data)?),
                0 => allowed_nssai = Some(AllowedNssai::aper_decode(data)?),
                171 => {
                    source_to_target_amf_information_reroute =
                        Some(SourceToTargetAmfInformationReroute::aper_decode(data)?)
                }
                174 => selected_plmn_identity = Some(PlmnIdentity::aper_decode(data)?),
                201 => iab_node_indication = Some(IabNodeIndication::aper_decode(data)?),
                224 => {
                    c_emode_b_support_indicator = Some(CEmodeBSupportIndicator::aper_decode(data)?)
                }
                225 => ltem_indication = Some(LtemIndication::aper_decode(data)?),
                227 => edt_session = Some(EdtSession::aper_decode(data)?),
                245 => authenticated_indication = Some(AuthenticatedIndication::aper_decode(data)?),
                259 => npn_access_information = Some(NpnAccessInformation::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
        let ran_ue_ngap_id = ran_ue_ngap_id.ok_or(PerCodecError::new(format!(
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.rrc_establishment_cause.aper_encode(ie)?;
    ...
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            match id {
                ...
                117 => ue_radio_capability = Some(UeRadioCapability::aper_decode(data)?),
                228 => {
                    ue_capability_info_request = Some(UeCapabilityInfoRequest::aper_decode(data)?)
                }
                226 => end_indication = Some(EndIndication::aper_decode(data)?),
                264 => ue_radio_capability_id = Some(UeRadioCapabilityId::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
...
impl RerouteNasRequest {
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.amf_set_id.aper_encode(ie)?;
        aper::encode::encode_integer(ies, Some(0), Some(65535), false, 3, false)?;
        Criticality::Reject.aper_encode(ies)?;
        aper::encode::encode_length_determinent(ies, None, None, false, ie.length_in_bytes())?;
        ies.append_aligned(ie);
...
impl NgSetupRequest {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            let _ = aper::decode::decode_length_determinent(data, None, None, false)?;
            match id {
                27 => global_ran_node_id = Some(GlobalRanNodeId::aper_decode(data)?),
                82 => ran_node_name = Some(RanNodeName::aper_decode(data)?),
                102 => supported_ta_list = Some(SupportedTaList::aper_decode(data)?),
                21 => default_paging_drx = Some(PagingDrx::aper_decode(data)?),
                147 => ue_retention_information = Some(UeRetentionInformation::aper_decode(data)?),
                204 => nb_iot_default_paging_drx = Some(NbIotDefaultPagingDrx::aper_decode(data)?),
                273 => extended_ran_node_name = Some(ExtendedRanNodeName::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.global_ran_node_id.aper_encode(ie)?;
        ...
        let ie = &mut PerCodecData::new_aper();
        self.supported_ta_list.aper_encode(ie)?;
        ...
        let ie = &mut PerCodecData::new_aper();
        self.default_paging_drx.aper_encode(ie)?;
...
impl NgSetupResponse {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            let _ = aper::decode::decode_length_determinent(data, None, None, false)?;
            match id {
                1 => amf_name = Some(AmfName::aper_decode(data)?),
                96 => served_guami_list = Some(ServedGuamiList::aper_decode(data)?),
                86 => relative_amf_capacity = Some(RelativeAmfCapacity::aper_decode(data)?),
                80 => plmn_support_list = Some(PlmnSupportList::aper_decode(data)?),
                19 => criticality_diagnostics = Some(CriticalityDiagnostics::aper_decode(data)?),
                147 => ue_retention_information = Some(UeRetentionInformation::aper_decode(data)?),
                200 => iab_supported = Some(IabSupported::aper_decode(data)?),
                274 => extended_amf_name = Some(ExtendedAmfName::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
        let amf_name =
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.served_guami_list.aper_encode(ie)?;
        ...
        let ie = &mut PerCodecData::new_aper();
        self.relative_amf_capacity.aper_encode(ie)?;
        ...
        let ie = &mut PerCodecData::new_aper();
        self.plmn_support_list.aper_encode(ie)?;
...
impl NgSetupFailure {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            match id {
                15 => cause = Some(Cause::aper_decode(data)?),
                107 => time_to_wait = Some(TimeToWait::aper_decode(data)?),
                19 => criticality_diagnostics = Some(CriticalityDiagnostics::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
            ...
            match id {
                ...
                167 => {
                    ngran_tnl_association_to_remove_list =
                        Some(NgranTnlAssociationToRemoveList::aper_decode(data)?)
                }
                204 => nb_iot_default_paging_drx = Some(NbIotDefaultPagingDrx::aper_decode(data)?),
                273 => extended_ran_node_name = Some(ExtendedRanNodeName::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            ...
            match id {
                ...
                6 => {
                    amf_tnl_association_to_add_list =
                        Some(AmfTnlAssociationToAddList::aper_decode(data)?)
                }
                7 => {
                    amf_tnl_association_to_remove_list =
                        Some(AmfTnlAssociationToRemoveList::aper_decode(data)?)
                }
                8 => {
                    amf_tnl_association_to_update_list =
                        Some(AmfTnlAssociationToUpdateList::aper_decode(data)?)
                }
                274 => extended_amf_name = Some(ExtendedAmfName::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
            ...
            match id {
                5 => {
                    amf_tnl_association_setup_list =
                        Some(AmfTnlAssociationSetupList::aper_decode(data)?)
                }
                4 => {
                    amf_tnl_association_failed_to_setup_list =
                        Some(TnlAssociationList::aper_decode(data)?)
                }
                19 => criticality_diagnostics = Some(CriticalityDiagnostics::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
...
impl AmfStatusIndication {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            let _ = aper::decode::decode_length_determinent(data, None, None, false)?;
            match id {
                120 => unavailable_guami_list = Some(UnavailableGuamiList::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.unavailable_guami_list.aper_encode(ie)?;
...
impl NgReset {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            match id {
                15 => cause = Some(Cause::aper_decode(data)?),
                88 => reset_type = Some(ResetType::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
        let cause = cause.ok_or(PerCodecError::new(format!("Missing mandatory IE cause")))?;
            ...
            match id {
                111 => {
                    ue_associated_logical_ng_connection_list =
                        Some(UeAssociatedLogicalNgConnectionList::aper_decode(data)?)
                }
                19 => criticality_diagnostics = Some(CriticalityDiagnostics::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
...
impl OverloadStart {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            let _ = aper::decode::decode_length_determinent(data, None, None, false)?;
            match id {
                2 => amf_overload_response = Some(OverloadResponse::aper_decode(data)?),
                9 => {
                    amf_traffic_load_reduction_indication =
                        Some(TrafficLoadReductionIndication::aper_decode(data)?)
                }
                49 => overload_start_nssai_list = Some(OverloadStartNssaiList::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
        Ok(Self {
            ...
            match id {
                99 => {
                    son_configuration_transfer_ul =
                        Some(SonConfigurationTransfer::aper_decode(data)?)
                }
                158 => {
                    endc_son_configuration_transfer_ul =
                        Some(EnDcsonConfigurationTransfer::aper_decode(data)?)
                }
                251 => {
                    intersystem_son_configuration_transfer_ul =
                        Some(IntersystemSonConfigurationTransfer::aper_decode(data)?)
                }
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
...
impl WriteReplaceWarningRequest {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            let _ = aper::decode::decode_length_determinent(data, None, None, false)?;
            match id {
                35 => message_identifier = Some(MessageIdentifier::aper_decode(data)?),
                95 => serial_number = Some(SerialNumber::aper_decode(data)?),
                122 => warning_area_list = Some(WarningAreaList::aper_decode(data)?),
                87 => repetition_period = Some(RepetitionPeriod::aper_decode(data)?),
                47 => {
                    number_of_broadcasts_requested =
                        Some(NumberOfBroadcastsRequested::aper_decode(data)?)
                }
                125 => warning_type = Some(WarningType::aper_decode(data)?),
                124 => warning_security_info = Some(WarningSecurityInfo::aper_decode(data)?),
                20 => data_coding_scheme = Some(DataCodingScheme::aper_decode(data)?),
                123 => warning_message_contents = Some(WarningMessageContents::aper_decode(data)?),
                17 => {
                    concurrent_warning_message_ind =
                        Some(ConcurrentWarningMessageInd::aper_decode(data)?)
                }
                141 => warning_area_coordinates = Some(WarningAreaCoordinates::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.message_identifier.aper_encode(ie)?;
        ...
        let ie = &mut PerCodecData::new_aper();
        self.serial_number.aper_encode(ie)?;
        ...
        let ie = &mut PerCodecData::new_aper();
        self.number_of_broadcasts_requested.aper_encode(ie)?;
            ...
            match id {
                ...
                13 => {
                    broadcast_completed_area_list =
                        Some(BroadcastCompletedAreaList::aper_decode(data)?)
                }
                19 => criticality_diagnostics = Some(CriticalityDiagnostics::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
    ...
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            match id {
                ...
                122 => warning_area_list = Some(WarningAreaList::aper_decode(data)?),
                14 => {
                    cancel_all_warning_messages = Some(CancelAllWarningMessages::aper_decode(data)?)
                }
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
            ...
            match id {
                ...
                12 => {
                    broadcast_cancelled_area_list =
                        Some(BroadcastCancelledAreaList::aper_decode(data)?)
                }
                19 => criticality_diagnostics = Some(CriticalityDiagnostics::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
...
impl PwsRestartIndication {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            let _ = aper::decode::decode_length_determinent(data, None, None, false)?;
            match id {
                16 => cell_id_list_for_restart = Some(CellIdListForRestart::aper_decode(data)?),
                27 => global_ran_node_id = Some(GlobalRanNodeId::aper_decode(data)?),
                104 => tai_list_for_restart = Some(TaiListForRestart::aper_decode(data)?),
                23 => {
                    emergency_area_id_list_for_restart =
                        Some(EmergencyAreaIdListForRestart::aper_decode(data)?)
                }
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.cell_id_list_for_restart.aper_encode(ie)?;
        ...
        let ie = &mut PerCodecData::new_aper();
        self.tai_list_for_restart.aper_encode(ie)?;
...
impl PwsFailureIndication {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            let _ = aper::decode::decode_length_determinent(data, None, None, false)?;
            match id {
                81 => pws_failed_cell_id_list = Some(PwsFailedCellIdList::aper_decode(data)?),
                27 => global_ran_node_id = Some(GlobalRanNodeId::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.pws_failed_cell_id_list.aper_encode(ie)?;
...
impl DownlinkUeAssociatedNrPPaTransport {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            match id {
                10 => amf_ue_ngap_id = Some(AmfUeNgapId::aper_decode(data)?),
                85 => ran_ue_ngap_id = Some(RanUeNgapId::aper_decode(data)?),
                89 => routing_id = Some(RoutingId::aper_decode(data)?),
                46 => nr_p_pa_pdu = Some(NrPPaPdu::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
        let amf_ue_ngap_id = amf_ue_ngap_id.ok_or(PerCodecError::new(format!(
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.routing_id.aper_encode(ie)?;
        ...
        let ie = &mut PerCodecData::new_aper();
        self.nr_p_pa_pdu.aper_encode(ie)?;
...
impl TraceFailureIndication {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            match id {
                10 => amf_ue_ngap_id = Some(AmfUeNgapId::aper_decode(data)?),
                85 => ran_ue_ngap_id = Some(RanUeNgapId::aper_decode(data)?),
                44 => ngran_trace_id = Some(NgranTraceId::aper_decode(data)?),
                15 => cause = Some(Cause::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.ngran_trace_id.aper_encode(ie)?;
    ...
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            match id {
                ...
                85 => ran_ue_ngap_id = Some(RanUeNgapId::aper_decode(data)?),
                44 => ngran_trace_id = Some(NgranTraceId::aper_decode(data)?),
                43 => ngran_cgi = Some(NgranCgi::aper_decode(data)?),
                109 => {
                    trace_collection_entity_ip_address =
                        Some(TransportLayerAddress::aper_decode(data)?)
                }
                256 => privacy_indicator = Some(PrivacyIndicator::aper_decode(data)?),
                257 => trace_collection_entity_uri = Some(UriAddress::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
        let amf_ue_ngap_id = amf_ue_ngap_id.ok_or(PerCodecError::new(format!(
...
impl LocationReportingControl {
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.location_reporting_request_type.aper_encode(ie)?;
        aper::encode::encode_integer(ies, Some(0), Some(65535), false, 33, false)?;
        Criticality::Ignore.aper_encode(ies)?;
        aper::encode::encode_length_determinent(ies, None, None, false, ie.length_in_bytes())?;
        ies.append_aligned(ie);
            ...
            match id {
                ...
                116 => {
                    ue_presence_in_area_of_interest_list =
                        Some(UePresenceInAreaOfInterestList::aper_decode(data)?)
                }
                33 => {
                    location_reporting_request_type =
                        Some(LocationReportingRequestType::aper_decode(data)?)
...
impl UeRadioCapabilityInfoIndication {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            match id {
                ...
                265 => {
                    ue_radio_capability_eutra_format = Some(UeRadioCapability::aper_decode(data)?)
                }
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.ue_radio_capability.aper_encode(ie)?;
        aper::encode::encode_integer(ies, Some(0), Some(65535), false, 117, false)?;
        Criticality::Ignore.aper_encode(ies)?;
        aper::encode::encode_length_determinent(ies, None, None, false, ie.length_in_bytes())?;
        ies.append_aligned(ie);
...
impl UeRadioCapabilityCheckResponse {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            match id {
                ...
                85 => ran_ue_ngap_id = Some(RanUeNgapId::aper_decode(data)?),
                30 => {
                    ims_voice_support_indicator = Some(ImsVoiceSupportIndicator::aper_decode(data)?)
                }
                19 => criticality_diagnostics = Some(CriticalityDiagnostics::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.ims_voice_support_indicator.aper_encode(ie)?;
            ...
            match id {
                ...
                142 => {
                    pdu_session_resource_secondary_rat_usage_list =
                        Some(PduSessionResourceSecondaryRatUsageList::aper_decode(data)?)
                }
                143 => handover_flag = Some(HandoverFlag::aper_decode(data)?),
                121 => {
                    user_location_information = Some(UserLocationInformation::aper_decode(data)?)
                }
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
...
impl UplinkRimInformationTransfer {
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            let _ = aper::decode::decode_length_determinent(data, None, None, false)?;
            match id {
                175 => rim_information_transfer = Some(RimInformationTransfer::aper_decode(data)?),
                x => return Err(PerCodecError::new(format!("Unrecognised IE type {}", x))),
            }
        }
        Ok(Self {
    ...
    fn decode_inner(data: &mut PerCodecData) -> Result<Self, PerCodecError> {
        ...
        for _ in 0..len {
            ...
            match id {
                ...
                209 => ue_differentiation_info = Some(UeDifferentiationInfo::aper_decode(data)?),
                212 => {
                    dl_cp_security_information = Some(DlCpSecurityInformation::aper_decode(data)?)
                }
                210 => nb_iot_ue_priority = Some(NbIotUePriority::aper_decode(data)?),
                205 => {
                    enhanced_coverage_restriction =
...
impl UeRadioCapabilityIdMappingRequest {
    ...
    fn encode_inner(&self, data: &mut PerCodecData) -> Result<(), PerCodecError> {
        ...
        let ie = &mut PerCodecData::new_aper();
        self.ue_radio_capability_id.aper_encode(ie)?;
        aper::encode::encode_integer(ies, Some(0), Some(65535), false, 264, false)?;
        Criticality::Reject.aper_encode(ies)?;
        aper::encode::encode_length_determinent(ies, None, None, false, ie.length_in_bytes())?;
        ies.append_aligned(ie);
